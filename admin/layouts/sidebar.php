					...
					<li class="sidebar-item">
						<a class='sidebar-link' href='<?=$site_url;?>/admin/category/index.php'>
							<i class="align-middle me-2 far fa-fw fa-calendar-alt"></i> <span class="align-middle">Category</span>
						</a>
					</li>

					
					<li class="sidebar-item">
						<a class='sidebar-link' href='<?=$site_url;?>/admin/users/index.php'>
							<i class="align-middle me-2 far fa-fw fa-calendar-alt"></i> <span class="align-middle">Userjgjg</span>
						</a>
					</li>
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-theme">
				...
				<form class="d-none d-sm-inline-block">
					<input class="form-control form-control-lite" type="text" placeholder="Xəbər Axtar...">
				</form>
